...
<body>
    ...
    <header class="masthead" style="background-image: url(&quot;assets/img/Canva%20-%20Green%20Grass%20Covered%20Mountain%20Under%20Blue%20Sky.jpg&quot;);">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                <div class="col-md-10 col-lg-8 mx-auto">
                    <div class="site-heading">
                        <h1>Hi, I'm Bryan</h1><span class="subheading">i'm just trying to figure things out</span></div>
                </div>
            </div>
        </div>
    </header>
    <div class="photo-gallery">
        <div class="container">
            <div class="intro">
                <h2 class="text-center">Some stuff I've made</h2>
                <p class="text-center">Nunc luctus in metus eget fringilla. Aliquam sed justo ligula. Vestibulum nibh erat, pellentesque ut laoreet vitae. </p>
            </div>
            <div class="row photos">
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a href="rapidrecipes.html"><img class="img-fluid" src="assets/img/Canva%20-%20Sliced%20Onion%20With%20Peppers%20and%20Radish%20on%20Cutting%20Board.jpg"><span style="font-family: 'Open Sans', sans-serif;font-weight: bold;font-size: 17px;">Rapid Recipes</span></a></div>
                <div class="col-sm-6 col-md-4 col-lg-3 item"><a data-lightbox="photos" href="assets/img/building.jpg"><img class="img-fluid" src="assets/img/Canva%20-%20Notebook%20Work%20with%20Statistics%20on%20Sofa%20Business.jpg"><span style="font-family: 'Open Sans', sans-serif;font-weight: bold;font-size: 18px;">Facebook Cache Validator</span></a></div>
